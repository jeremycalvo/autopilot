...
export default function RegisterScreen({ navigation }) {
    ...
    const handleLogin = async () => {
      try {
        const response = await axios.post ('http://' + urls.backUrl + '/register',
         data
        );
    ...
    <View style={styles.container}>
      ...
      <Text style={styles.registertitle}>If you already have an account register</Text>
      <Text style={styles.registertitle2}>You can</Text>
      <TouchableOpacity
        onPress={() => navigation.navigate("Login")}
        style={styles.Registerbutton}
      >
        <Text style={styles.RegisterButtonText}>Login here !</Text>
      </TouchableOpacity>
      <TextInput  
